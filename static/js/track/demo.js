...
var Test_ak = 'lw0GaMi16G4kOPWbpfKdoanVA7MukqXT';
var ServiceId = '132164';
var mcode = '58:90:05:BB:B0:79:E0:D6:44:C6:C7:CD:F5:17:DF:52:4C:79:D5:2C;com.thinktorch.zhangshanghuanbao';
    ...
    return {
        ...
        loadData_2: function (pageIndex, before, after) {
            ...
            if (typeof keyWord_2 == 'string' && keyWord_2.length > 0) {
                params.user_real_name = keyWord_2;
            }
            var time = new Date().setHours(0, 0, 0) / 1000;
            var before = before || function () {
                $('.panel-mask').show();
